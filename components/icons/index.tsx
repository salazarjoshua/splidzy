...
export const Loader: React.FC<React.SVGProps<SVGElement>> = ({
  className,
}: {
  className?: string;
}) => (
  ...
  >
    <path
      fill="currentColor"
      d="M12 2c-.6 0-1 .4-1 1v2.5c0 .6.4 1 1 1s1-.4 1-1V3c0-.6-.4-1-1-1M6.7 8.1c.2.2.5.3.7.3s.5-.1.7-.3c.4-.4.4-1 0-1.4L6.3 4.9c-.4-.4-1-.4-1.4 0s-.4 1 0 1.4zM6.5 12c0-.6-.4-1-1-1H3c-.6 0-1 .4-1 1s.4 1 1 1h2.5c.5 0 1-.4 1-1m.201 3.9-1.7 1.7c-.4.4-.4 1 0 1.4.2.2.5.3.7.3s.5-.1.7-.3l1.7-1.7c.4-.4.4-1 0-1.4s-1-.4-1.4 0M12 17.5c-.6 0-1 .4-1 1V21c0 .6.4 1 1 1s1-.4 1-1v-2.5c0-.5-.4-1-1-1m5.3-1.6c-.4-.4-1-.4-1.4 0s-.4 1 0 1.4l1.7 1.7c.2.2.5.3.7.3s.5-.1.7-.3c.4-.4.4-1 0-1.4zM21 11h-2.5c-.6 0-1 .4-1 1s.4 1 1 1H21c.6 0 1-.4 1-1s-.4-1-1-1m-4.4-2.6c.3 0 .5-.1.7-.3L19 6.4c.4-.4.4-1 0-1.4s-1-.4-1.4 0l-1.7 1.7c-.4.4-.4 1 0 1.4.2.2.5.3.7.3"
    ></path>
  </svg>
);

export const Settings: React.FC<React.SVGProps<SVGElement>> = ({
  className,
}: {
  className?: string;
}) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M9.142 21.586a10 10 0 0 1-4.348-2.652 3 3 0 0 0-2.59-4.919A10.04 10.04 0 0 1 2.457 9H2.5a3 3 0 0 0 2.692-4.325 10 10 0 0 1 4.134-2.313 3 3 0 0 0 5.348 0 10 10 0 0 1 4.134 2.313A3 3 0 0 0 21.542 9a10.04 10.04 0 0 1 .255 5.015 3 3 0 0 0-2.59 4.919 10 10 0 0 1-4.349 2.652 3.001 3.001 0 0 0-5.716 0Z"
    ></path>
    <path
      stroke="currentColor"
      strokeLinejoin="round"
